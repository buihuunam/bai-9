...
void arrSelectionSort(int *, ints);
...
int main()
{
    ...
    arrSelectionSort(arrPtrs, number_of_donation);

    // Display the donations using the array of pointers. This
    // will display them in sorted order.
    cout << "The donations, sorted in ascending order are: \n";
    showArrPtr(arrPtr, number_of_donation);
    ...
    showArray(donationer, number_of_donation);
...
void arrSelectionSorts(int *arr, int sizes)
{
